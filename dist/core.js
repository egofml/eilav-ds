...
const api={spacingEligible,checkedSpacing,exclusionReasons,HEADERS,COPY_HEADERS,FREE_COPY_HEADERS,copyHeaders,exportBlock,parseTSV,stringify,tableFrom,normalize,termsFrom,makeMatcher,fee,placeKeywords,placeAIKeywords,applyKeywordReview,analyze,approve,exportRows};if(typeof module!=='undefined'&&module.exports)module.exports=api;else root.DS=api;
